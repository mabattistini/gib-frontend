                                ...
                                <div className="mCustomScrollbar" data-mcs-theme="dark">
									...
									<a href="#" className="accept-request request-del">
                                        ...
                                        <li className="accepted">
                                            ...
                                            <div className="notification-event">
                                                You and <a href="#" className="h6 notification-friend">Mary Jane
                                                Stark</a> just became friends. Write on
									...
									<svg className="olymp-chat---messages-icon"><use
                                        ...
                                        <li>
                                            ...
                                            <div className="notification-event">
                                                ...
                                                <span
                                                    className="chat-message-item">Great, I’ll see you tomorrow!.</span>
                                                <span className="notification-date">
                                                    <time className="entry-date updated" dateTime="2004-07-24T18:18">4 hours ago</time></span>
                                            </div>
                                            <span className="notification-icon">
									<svg className="olymp-chat---messages-icon"><use
                                        xlinkHref="#olymp-chat---messages-icon"/></svg>
                                        ...
                                        <li className="chat-group">
                                            ...
                                            <div className="notification-event">
                                                <a href="#" className="h6 notification-friend">You, Faye, Ed &amp; Jet
                                                    +3</a>
                                ...
                                <div className="mCustomScrollbar" data-mcs-theme="dark">
                                    <ul className="notification-list">
                                        ...
                                        <li>
                                            ...
                                            <div className="notification-event">
                                                <div><a href="#" className="h6 notification-friend">Green Goo
                                                    Rock</a> invited you to attend to his event Goo in <a href="#"
                                                                                                          className="notification-link">Gotham
                                                    Bar</a>.
                                                </div>
                                                <span className="notification-date"><time className="entry-date updated"
										...
										<svg className="olymp-heart-icon"><use
                                            xlinkHref="#olymp-heart-icon"/></svg>
									</span>
